...
const Dashboard = () => {
  ...
  const Sidebar = ({ isOpen, onClose }) => (
    <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 h-screen flex flex-col`}>
      ...
      <nav className="flex-1 mt-8 px-4 overflow-y-auto">
        <div className="space-y-2">
          <Link to="/dashboard" className="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
          ...
          {authUser?.role === 'Student' && (
            <>
              <Link to="/tests" className="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <TestTube className="h-5 w-5 mr-3" />
                Available Tests
              </Link>
              <Link to="/results" className="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
          ...
          {authUser?.role === 'Educator' && (
            <>
              <Link to="/create-test" className="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
          ...
          {authUser?.role === 'Admin' && (
            <>
              <Link to="/admin" className="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
